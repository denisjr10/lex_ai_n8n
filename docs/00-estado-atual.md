...
| 🟢 **A vigilância de prazo ganhou nome — e sobra uma frequência para decidir** | **05/09** (D-205, PRD §9.3.2). A **Malu Souza** (~289 processos) vai de **V1 — nome no diário oficial, R$ 3,00/mês**; por processo custaria R$ 867,00. A **Ana Beatriz** (~24 processos) vai de **V2 — um monitoramento por processo**. O que falta é a **frequência** dela: `diaria` (R$ 55,20 a R$ 72,00/mês) ou `mensal` (R$ 4,32/mês). **Não são dois produtos** — é a mesma rota com dois campos no corpo, e o mensal detecta em até 30 dias, o que **não é vigilância de prazo**: ele aparece como ativo no painel e não acusa falha (colide com RF-15). Minha posição é **diária**; a diferença é R$ 67,68/mês. Nasceu junto a **R-69** — o V1 cobre processo que ninguém cadastrou, o V2 não, então a cobertura da Ana Beatriz depende de o cadastro estar completo |
