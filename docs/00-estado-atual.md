...
| **2** | Antes do primeiro dado real de cliente — travas de execução, tetos no receptor, isolamento por inquilino | 🔶 **9 de 10 fechados** — `bc954d6` (D-238, D-240), `b71f494` (D-236), `917baaf` (D-237), migração **014** (D-239) e migração **015** (D-241). Falta só a **revalidação de origem do callback** (2.6), que fecha o bloco |
