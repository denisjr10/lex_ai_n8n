...
| **2** | Antes do primeiro dado real de cliente — travas de execução, tetos no receptor, isolamento por inquilino | 🔶 **8 de 10 fechados** — `bc954d6` (D-238, D-240), `b71f494` (D-236), `917baaf` (D-237) e a migração **014** (D-239). Faltam os **tetos do receptor** (2.5) e a **revalidação de origem do callback** (2.6) |
