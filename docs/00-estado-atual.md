...
| 🟢 **A pilha de aval foi triada — 179, não 173, e o digesto existe** | **08/09** (**P-17**, [`18-digesto-de-aval.md`](18-digesto-de-aval.md)). A §13 tem **182 em 🟡 Proposta** e **31 confirmadas** — eram 179 antes de a própria conversa gerar D-216 a D-218 — a conta antiga de "173 contra 2" estava errada dos dois lados. Elas saíram em três grupos: **15 que pedem leitura individual** (7 urgentes antes de 15/09), **159 de acordo em bloco** e **8 que não deveriam estar em Proposta**. **v2.0, de 08/09:** cada ficha do grupo A ganhou contexto, exemplo concreto, os números em reais e uma linha de decisão para marcar; os 18 blocos passaram a dizer o que decidem em vez de nomear o assunto; e entrou um **glossário** do vocabulário do projeto. Nenhuma recomendação mudou — só a forma de apresentar. ✅ **Duas coisas já foram resolvidas no mesmo dia:** a colisão de numeração (linha acima) e a **D-171**, que não era exceção esquecida e sim decisão de negócio — virou **D-216** (linha acima). **Nenhum outro status foi alterado** — o aval é do usuário |
