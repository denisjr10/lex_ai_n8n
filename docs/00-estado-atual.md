...
| 5 | 🔴 **A Demo B afirma ao cliente uma revisão que não acontece:** o nó `Enviar ao cliente` anexa *"revisada por um advogado do escritório"*, e o caminho é webhook → porteiro → ficha → modelo → envio, sem pessoa nenhuma. É trocar uma string | `demo/workflows/B-cliente-whatsapp.json` |
