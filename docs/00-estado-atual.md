...
| **2** | Antes do primeiro dado real de cliente — travas de execução, tetos no receptor, isolamento por inquilino | 🔶 **7 de 10 fechados** — `bc954d6` (D-238, D-240), `b71f494` (D-236) e `917baaf` (D-237). Faltam os **tetos do receptor** (2.5), a **origem do callback** (2.6) e a **migração da D-239** (2.3, que exige o banco de pé) |
