...
| D-155 | **Nenhum texto afirma revisão humana onde não há aprovação humana.** A rota de consulta da Demo B envia resposta de texto livre ao cliente **sem parar em ninguém** — e a nota de rodapé dizia "revisada por um advogado do escritório", copiada da Demo A, onde a frase é fato porque o texto para no Telegram. Aqui era declaração falsa a cliente, em canal regido pelo Provimento 205/2021 da OAB. A frase passa a dizer o que é — mensagem automática, **não** revisada por advogado — e oferece a rota humana que já existe no Porteiro. **É a D-101 aplicada a quem escreve o texto, não só a quem mostra o estado:** rótulo não afirma fato que não aconteceu. Regressão em `demo/testar-fluxo-b.mjs`. **A demo permanece sem aprovação humana nesta rota — exceção consciente, limitada à demonstração**, e ela não sobrevive à produção: pela D-142 aquilo é texto livre, portanto **A3b**, que exige aprovação mensagem a mensagem. Enquanto a rota não tiver o nó de aprovação, ela não atende cliente real | Adotar, e não levar à produção assim | ✅ **Confirmada** (revisão externa, 28/08) |
