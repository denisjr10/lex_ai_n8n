...
| D-101 | Durante a cota de teste, o débito é de **R$ 3,00 por requisição paga**; rotas gratuitas não consomem saldo nem cota. **Corrige D-55** — calibrar preço por rota só é possível no pré-pago | — | ✅ **Confirmada** (suporte, 25/08) |
| D-102 | A tabela do painel é o **catálogo real do pré-pago**. P-06 encerrada: o modelo de custo do PRD §9 se apoia em preço confirmado | — | ✅ **Confirmada** (suporte, 25/08) |
